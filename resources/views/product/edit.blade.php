...
{!! Form::model($product, array('action' => 'ProductController@update','post','enctype' => 'multipart/form-data'))!!}
...
<table>
    ...
    <tr>
        ...
        <td>{{ Form::select('category_id',$categories,Request::old('categiry_id'),['class'=>'form-control'])}}</td>
    </tr>
